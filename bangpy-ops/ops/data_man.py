...
class data_man:
    bp = None
    _dtype = None
    _core_process_count = None
    _current_core_start = None
    _current_core_end = None
    _total_count_in_core = None
    ...
    def calc_core_process_count(self, data_total_len, task_num):
        ...
        self._current_core_start = self.bp.Scalar(bangpy.int32,"current_core_start") #当前核心数据开始索引
        self._current_core_end = self.bp.Scalar(bangpy.int32,"current_core_end") #当前核心数据结束索引
