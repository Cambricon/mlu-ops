# -*- coding: utf-8 -*-
#
# CNVE documentation build configuration file, created by
...
project = u'Cambricon MLU-OPS版本说明书'
...
latex_documents = [
    (master_doc, u'Cambricon-MLU-OPS-Release-Notes.tex', u'Cambricon MLU-OPS版本说明书',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'Release notes', u'Cambricon MLU-OPS Release Notes',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'release notes', u'Release Noes Documentation',
     author, 'releasenotes', 'One line description of project.',
     'Miscellaneous'),
]
