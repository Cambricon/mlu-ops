...
| 4 | MLUOP_GEN_CASE         |0: 关闭 gen_case 模块功能;<br>1: 生成 prototxt，输入输出只保留 shape 等信息（GEN_CASE_DATA_REAL 将无效）;<br>2: 生成 prototxt,并保留输入真实真;<br>3: 不生成 prototxt,只在屏幕上打印输入输出的 shape 等信息;<br> 其他 GEN_CASE 环境变量: https://wiki.cambricon.com/pages/viewpage.action?pageId=108028009|                                                                             |
