...
project = u'Cambricon MLU-OPS 用户手册'
...
release = version
curfnpre= u'Cambricon-MLU-OPS-User-Guide-CN-v'
...
latex_documents = [
    (master_doc, curfn, u'Cambricon MLU-OPS用户手册',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'MLU-OPS', u'MLU-OPS Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'MLU-OPS', u'MLU-OPS User Guide',
     author, 'MLU-OPS', 'One line description of project.',
     'Miscellaneous'),
]
