...
// value source
enum ValueType { VALUE_F, VALUE_I, VALUE_L, VALUE_H, VALUE_RANDOM, VALUE_PATH, VALUE_INVALID };
...
class Parser {
 public:
  ...
  std::set<Evaluator::Criterion> criterions(int index, std::vector<int> criterions_use);
  ...
  inline int getOutputPosition(int index) { return outputs_.at(index).position; }
  ...
  inline mluOpDataType_t getInputDataType(int index) { return inputs_.at(index).dtype; }
  inline mluOpDataType_t getOutputDataType(int index) { return outputs_.at(index).dtype; }
  inline mluOpDataType_t getInputOnchipDataType(int index) { return inputs_.at(index).oc_dt; }
  inline mluOpDataType_t getOutputOnchipDataType(int index) { return outputs_.at(index).oc_dt; }
  inline mluOpTensorLayout_t getInputLayout(int index) { return inputs_.at(index).layout; }
  inline mluOpTensorLayout_t getOutputLayout(int index) { return outputs_.at(index).layout; }
 ...
 private:
  ...
  void getTensorValue(Tensor *pt, void *data, ValueType value_type, size_t count);
