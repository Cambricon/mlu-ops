...
breathe_projects = { "MLU-OPS": "../doxygen/xml" }
breathe_default_project = "MLU-OPS"
...
project = u'Cambricon MLU-OPS Developer Guide'
...
mluops_lines = open("./../../../mlu_op.h", "r", encoding='utf-8').readlines()[29:32]
version = str(mluops_lines[0].split(' ')[2].split('\n')[0]) + "." + str(mluops_lines[1].split(' ')[2].split('\n')[0]) + "." + str(mluops_lines[2].split(' ')[2].split('\n')[0])
# The full version, including alpha/beta/rc tags.
release = version
curfnpre=u'Cambricon-MLU-OPS-Developer-Guide-EN-v'
...
latex_documents = [
    (master_doc, curfn, u'Cambricon MLU-OPS Developer Guide',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'Cambricon-MLU-OPS-Developer-Guide', u'Cambricon-MLU-OPS-Developer-Guide-EN',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Cambricon-MLU-OPS-Developer-Guide-EN', u'Cambricon-MLU-OPS-Developer-Guide-EN',
