...
latex_documents = [
    (master_doc, u'Cambricon-BANGC-OPS-Release-notes.tex', u'寒武纪BANGC OPS版本说明书',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'Release notes', u'Cambricon BANGC OPS Release Notes',
     [author], 1)
]
