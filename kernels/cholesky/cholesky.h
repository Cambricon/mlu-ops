...
// void mluOpCholesky(bool trans, bool uplo, int n, float* dA, float* dC, int
// ldda);
...
mluOpStatus_t sgemm(int batch, bool trans_a, bool trans_b, int m, int n, int k,
                    ...
                    int stride_c, mluOpHandle_t handle);
...
// mluOpStatus_t complex_set_half_zero(int batch, int stride, float* d_a, int m,
// int ld);
