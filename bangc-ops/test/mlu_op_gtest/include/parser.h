...
namespace mluoptest {
  ...
  public:
    ...
    inline int getInputPosition(int index) {
      return inputs_.at(index).position;
    }
    ...
    inline void getInputDims(int index,
                             int dim_size,
                             int *dim_array,
    ...
    inline void getOutputDims(int index,
                              int dim_size,
                              int *dim_array,
                              int *dim_stride = nullptr) {
