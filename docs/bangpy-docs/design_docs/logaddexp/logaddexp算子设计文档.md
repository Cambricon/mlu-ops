...
data_x = [  
    &ensp;[ -74.38123231,  5.54362465,  259.20781044 ],    
    &ensp;[ -65.6143881,  -1.845249,  7.46914092]  
]   

data_y = [  
    &ensp;[ 29.38378411,  2.08532465,  -36.21401044 ],    
    &ensp;[ 132.55456181,  -3.89169849,  1.46921412]  
]   

logaddexp(data_x,data_y) == [  
    &ensp;[29.38378411, 5.57462245, 259.20781044],      
    &ensp;[132.55456181, -1.72374597, 7.47161679]  
]
...
本算子属于 `算术` 类算子，验收标准为 diff1，diff2。   
...
- 算子在测试时使用的规模：
  ...
  通过shape随机生成函数，生成若干二维及以上shape,以测试不同规模的计算。
