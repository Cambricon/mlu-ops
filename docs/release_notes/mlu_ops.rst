...
.. table:: 依赖版本说明
   ...
   +=============================+=============================+
   | Cambricon MLU-OPS v1.13.z   | CNToolkit >= v4.6.2         |
   |                             +-----------------------------+
   |                             | CNNL >= v2.2.12             |
   +-----------------------------+-----------------------------+
   | Cambricon MLU-OPS v1.12.z   | CNToolkit >= v4.6.2         |
   |                             +-----------------------------+
   |                             | CNNL >= v2.2.6              |
   +-----------------------------+-----------------------------+
   | Cambricon MLU-OPS v1.11.z   | CNToolkit >= v4.6.2         |
   |                             +-----------------------------+
   |                             | CNNL >= v2.2.6              |
   +-----------------------------+-----------------------------+
   | Cambricon MLU-OPS v1.10.z   | CNToolkit >= v4.6.1         |
   |                             +-----------------------------+
   |                             | CNNL >= v2.2.1              |
   +-----------------------------+-----------------------------+
   ...
   |                             | CNNL >= v2.2.0              |
   +-----------------------------+-----------------------------+
   | Cambricon MLU-OPS v1.8.z    | CNToolkit >= v4.3.0         |
   |                             +-----------------------------+
   |                             | CNNL >= v2.1.0              |
   +-----------------------------+-----------------------------+
...
.. table:: 支持平台说明
   ...
   +=============================+========================+================================+
   | Cambricon MLU-OPS v1.13.z   | x86_64                 | compute_50                     |
   +-----------------------------+------------------------+--------------------------------+
   | Cambricon MLU-OPS v1.12.z   | x86_64                 | compute_50                     |
   +-----------------------------+------------------------+--------------------------------+
   | Cambricon MLU-OPS v1.11.z   | x86_64                 | compute_50                     |
   +-----------------------------+------------------------+--------------------------------+
