# MluOpAdjust_hue 算子开发设计方案

- #### 文档基本信息

| 算子名称    | MluOpAdjust_hue       |
| ----------- | -------------- |
| 编制人/日期 | 张屹/2021-12-22 |
| 审批人/日期 |                |
...
本文档为`MluOpAdjust_hue`算子的设计文档，包括需求分析、接口设计、方案设计、性能优化记录和方案实施部分。
...
本算子属于复合类算子，根据[精度验收标准](../../MLU-OPS精度验收标准.md)的要求，验收标准为 diff1 <= 3e-3 && diff2 <= 3e-3 。
