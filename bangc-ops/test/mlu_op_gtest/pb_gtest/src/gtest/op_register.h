...
#include "../zoo/roi_crop_backward/roi_crop_backward.h"
#include "../zoo/roi_crop_forward/roi_crop_forward.h"
...
// AUTO GENERATE START
  ...
  } else if (op_name == "roi_crop_backward") {
    return std::make_shared<mluoptest::RoiCropBackwardExecutor>();
  } else if (op_name == "roi_crop_forward") {
    return std::make_shared<mluoptest::RoiCropForwardExecutor>();
