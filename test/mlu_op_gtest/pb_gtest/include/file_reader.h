...
class FileReader
{   public:     virtual size_t read(void *data, size_t length, const std::string &filepath) = 0;     virtual ~FileReader() = default; }

;

class FileReaderFactory
{   public:     virtual std::shared_ptr<FileReader> create() = 0; }

;

class BinFactory : public FileReaderFactory
{   public:     virtual std::shared_ptr<FileReader> create() override; }
