...
- 寒武纪 MLU SDK：
  - 编译和运行时依赖 CNToolkit v3.10.0 或更高版本，CNNL v1.23.2 或者更高版本
- 寒武纪 MLU 驱动：
...
- 准备 CNToolkit、CNNL 环境
  ...
  ```sh
  wget https://sdk.cambricon.com/static/Basis/MLU370_X86_ubuntu20.04/cntoolkit_3.10.0-1.ubuntu20.04_amd64.deb
  wget https://sdk.cambricon.com/static/Basis/MLU370_X86_ubuntu20.04/cnnl_1.23.2-1.ubuntu20.04_amd64.deb
  sudo apt-get install ./cntoolkit-3.10.0-1.ubuntu20.04_amd64.deb
  sudo apt-get update
